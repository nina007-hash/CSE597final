...
def get_args():
    ...
    parser.add_argument('--vl_model', type=str, default=r'./checkpoints/HuggingFace/clip-vit-base-patch32')
    parser.add_argument("--parser_checkpoint", type=str, default=r'./checkpoints/HuggingFace/flan-t5-base-VG-factual-sg')
    parser.add_argument("--wte_model_path", type=str, default=r'./checkpoints/HuggingFace/all-MiniLM-L6-v2')  # why all-Mini-L6-v2  all-MiniLM-L6-v2? 
